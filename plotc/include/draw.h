...
extern float axisXValues[MAX_GRID_LINE];
extern float axisYValues[MAX_GRID_LINE];
extern float gridPositionModelX[MAX_GRID_LINE];
extern float gridPositionModelY[MAX_GRID_LINE];
extern int gridPositionProjectionX[MAX_GRID_LINE];
extern int gridPositionProjectionY[MAX_GRID_LINE];
